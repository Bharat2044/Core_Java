...
public class _18_BlockScopeEx3 {
  
    int a = 10;
    // System.out.println("Value outside main method = " + a);  // BlockScopeEx3.java:6: error: illegal start of type
    
    {
        ...
        {
          // int a = 99;   // BlockScopeEx3.java:13: error: variable a is already defined in instance initializer of class BlockScopeEx1
        }
    }
